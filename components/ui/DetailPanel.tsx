...
import { X, Activity, Shield, AlertTriangle, Cpu, FileText, BarChart3 } from 'lucide-react';
...
export const DetailPanel: React.FC<DetailPanelProps> = ({ data, onClose }) => {
  ...
  return (
    <div className="absolute z-50 w-64 font-mono pointer-events-none top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 md:top-24 md:right-72 md:left-auto md:translate-x-0 md:translate-y-0">
      <div className="pointer-events-auto bg-[#121212]/80 backdrop-blur-sm p-2 border-b border-[#E42737]/50 shadow-[0_0_20px_rgba(0,0,0,0.5)]">
         <div className="flex items-center justify-between pb-2 mb-2 border-b border-[#E42737]/20">
            ...
            <button onClick={onClose} className="text-slate-500 hover:text-[#E42737] transition-colors"><X size={14} /></button>
         </div>
         ...
         <div className="h-1 w-full bg-[#E42737]/20 mt-3 flex justify-start"><div className="w-1/3 h-full bg-[#E42737]/50"></div></div>
      </div>
    </div>
  );
};
